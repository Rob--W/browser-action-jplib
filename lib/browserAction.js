...
function createCallbackGetter(getter) function(details, callback) {
    ...
    if (typeof details != 'object' || typeof callback != 'function') {
        throw new Error("Invocation of form browserAction.getTitle(null, function) doesn't match definition browserAction.getTitle(object details, function callback)");
    }
    callback(getter());
}
...
function Badge(badgeOptions) { // Exported
    ...
    browserAction.setIcon = function(details) {
        details = validateOptions(details, {
            ...
            path: {
                map: function(path) RESOURCE(typeof path == 'string' ? path : path['19'] || path['38']),
                is: ['string']
            }   
        });
    ...
    browserAction.setPopup = function(details) {
        details = validateOptions(details, {
            popup: {
                map: function(path) RESOURCE(path),
